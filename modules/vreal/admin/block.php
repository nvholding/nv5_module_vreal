...
$set_active_op = 'real_block';

$sql = 'SELECT bid, ' . NV_LANG_DATA . '_title FROM ' . $db_config['prefix'] . '_' . $module_data . '_real_block ORDER BY weight ASC';
$result = $db->query( $sql );
...
{
	Header( 'Location: ' . NV_BASE_ADMINURL . 'index.php?' . NV_NAME_VARIABLE . '=' . $module_name . '&' . NV_OP_VARIABLE . '=real_block' );
}
