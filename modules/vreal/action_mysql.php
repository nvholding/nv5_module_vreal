...
if( in_array( $lang, $array_lang_module_setup ) and $num_table > 1 )
{
	...
	$sql_drop_module[] = 'ALTER TABLE ' . $db_config['prefix'] . '_' . $module_data . '_real_block
	 DROP ' . $lang . '_title,
	 DROP ' . $lang . '_alias,
	 DROP ' . $lang . '_description,
	 DROP ' . $lang . '_keywords';

	$sql_drop_module[] = 'ALTER TABLE ' . $db_config['prefix'] . '_' . $module_data . '_real_type
	 DROP ' . $lang . '_title,
	 DROP ' . $lang . '_alias';
...
elseif( $op != 'setup' )
{
	...
	$sql_drop_module[] = 'DROP TABLE IF EXISTS ' . $db_config['prefix'] . '_' . $module_data . '_real_block';
	...
	$sql_drop_module[] = 'DROP TABLE IF EXISTS ' . $db_config['prefix'] . '_' . $module_data . '_real_type';
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_rows (
 ...
 group_id varchar(250) NOT NULL DEFAULT '',
 user_id mediumint(8) NOT NULL DEFAULT '0',
 r_id mediumint(8) NOT NULL DEFAULT '0',
 ...
 property tinyint(2) NOT NULL DEFAULT '0',
 propatt varchar(250) NOT NULL DEFAULT '', 
 gmap varchar(250) NOT NULL DEFAULT '', 
 caddress varchar(250) NOT NULL DEFAULT '',  
...
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_rows ADD " . $lang . "_title VARCHAR( 250 ) NOT NULL DEFAULT '',
 ...
 ADD " . $lang . "_design text NOT NULL,
 ADD " . $lang . "_utility text NOT NULL,
 ADD " . $lang . "_policy text NOT NULL,  
 ADD " . $lang . "_bodytext text NOT NULL,
 ADD " . $lang . "_support text NOT NULL, 
 ADD " . $lang . "_realtitle VARCHAR( 250 ) NOT NULL DEFAULT '', 
 ADD " . $lang . "_realinfo text NOT NULL";

$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_real_type (
...
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_real_type ADD " . $lang . "_title VARCHAR( 250 ) NOT NULL DEFAULT '',
 ADD " . $lang . "_alias VARCHAR( 250 ) NOT NULL DEFAULT ''";
 
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_real_block (
...
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_real_block ADD " . $lang . "_title VARCHAR( 250 ) NOT NULL DEFAULT '',
 ADD " . $lang . "_alias VARCHAR( 250 ) NOT NULL DEFAULT '',
...
if( ! empty( $set_lang_data ) )
{
	...
	if( $numrow )
	{
		...
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_hometext = " . $set_lang_data . "_address";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_hometext = " . $set_lang_data . "_design";		
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_hometext2 = " . $set_lang_data . "_utility";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_bodytext = " . $set_lang_data . "_policy";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_bodytext = " . $set_lang_data . "_bodytext";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_warranty = " . $set_lang_data . "_support";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_promotional = " . $set_lang_data . "_realtitle";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET " . $lang . "_note = " . $set_lang_data . "_realinfo";
	}
	...
	$numrow = $db->query( "SELECT count(*) FROM " . $db_config['prefix'] . "_" . $module_data . "_real_type" )->fetchColumn();
	if( $numrow )
	{
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_real_type SET " . $lang . "_title = " . $set_lang_data . "_title";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_real_type SET " . $lang . "_alias = " . $set_lang_data . "_alias";
	}

	$numrow = $db->query( "SELECT count(*) FROM " . $db_config['prefix'] . "_" . $module_data . "_real_block" )->fetchColumn();
	if( $numrow )
	{
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_real_block SET " . $lang . "_title = " . $set_lang_data . "_title";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_real_block SET " . $lang . "_alias = " . $set_lang_data . "_alias";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_real_block SET " . $lang . "_description = " . $set_lang_data . "_description";
		$sql_create_module[] = "UPDATE " . $db_config['prefix'] . "_" . $module_data . "_real_block SET " . $lang . "_keywords = " . $set_lang_data . "_keywords";
	}
...
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_real_block ADD UNIQUE (" . $lang . "_alias)";
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_real_type ADD UNIQUE (" . $lang . "_alias)";
