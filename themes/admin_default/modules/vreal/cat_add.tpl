		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<tr>
					...
					<td><input class="form-control" style="width: 650px" name="title" type="text" value="{DATA.title}" maxlength="255" id="idtitle" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					&nbsp; <em class="fa fa-refresh fa-lg fa-pointer" onclick="get_alias('cat', {DATA.catid});">&nbsp;</em>
					</td>
				</tr>
				<tr>
