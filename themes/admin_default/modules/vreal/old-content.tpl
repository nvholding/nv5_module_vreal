			...
			<tr>
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td><input type="text" maxlength="255" value="{rowcontent.promotional}" name="promotional" id="idpromotional" class="form-control" style="width:98%" /></td>
					</tr>
				</table>
				<table class="table table-striped table-bordered table-hover">
					<tbody>
					...
					<tbody id="otherimage">
						<!-- BEGIN: otherimage -->
						<tr>
							<td><input value="{DATAOTHERIMAGE.value}" name="otherimage[]" id="otherimage_{DATAOTHERIMAGE.id}" class="form-control" maxlength="255"><input value="{LANG.browse_image}" name="selectfile" onclick="nv_open_browse( '{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=otherimage_{DATAOTHERIMAGE.id}&path={NV_UPLOADS_DIR}/{module_upload}&currentpath={CURRENT}&type=file', 'NVImg', 850, 500, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no' ); return false; " type="button"></td>
						</tr>
						<!-- END: otherimage -->
						<tr>
				...
				<table class="table table-striped table-bordered table-hover">
					<tbody>
						...
						<tr>
							<td><strong>{LANG.content_hometext2} </strong> {LANG.content_notehome}</td>
						</tr>
						<tr>
							<td>								
