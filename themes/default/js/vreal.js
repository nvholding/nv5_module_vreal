...
function onsubmitsearch() {
	...
	if (keyword == '' && price1 == '' && price2 == '' && cataid == 0 && sid == 0) {
		...
		window.location.href = nv_siteroot + 'index.php?' + nv_lang_variable + '=' + nv_sitelang + '&' + nv_name_variable + '=real&' + nv_fc_variable + '=search_result&keyword=' + rawurlencode(keyword) + '&price1=' + price1 + '&price2=' + price2 + '&typemoney=' + typemoney + '&cata=' + cataid + '&sid=' + sid;
	}
	return false;
}
