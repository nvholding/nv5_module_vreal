	...
	$.ajax({
		...
		success : function(data) {
			...
			if (strText != null) {
				...
				$("#cart_" + nv_module_name).on('load', linkloadcart);
...
function onsubmitsearch() {
	...
	if (typemoney == null)
		typemoney = '';
	var cataid = $('#cata').val();
	if (keyword == '' && price1 == '' && price2 == '' && cataid == 0 && rid == 0) {
		return false;
	} else {
		window.location.href = nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=vreal&' + nv_fc_variable + '=search_result&keyword=' + rawurlencode(keyword) + '&price1=' + price1 + '&price2=' + price2 + '&typemoney=' + typemoney + '&cata=' + cataid + '&rid=' + rid;
	}
	return false;
}
...
function onsubmitsearch1() {
	...
	if (keyword == '' && price1 == '' && price2 == '' && cataid == 0 && rid == 0) {
		...
		window.location.href = nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=search_result&keyword=' + rawurlencode(keyword) + '&price1=' + price1 + '&price2=' + price2 + '&typemoney=' + typemoney + '&cata=' + cataid + '&rid=' + rid;
	}
	return false;
}

function onsubmitsearch2(module) {
	...
	if (price2 == null)
		price2 = '';
	var typemoney = $('#typemoney2').val();
	if (typemoney == null)
		typemoney = '';
	var cataid = $('#cata2').val();
	var rid = $('#rid2').val();	
	if (keyword == '' && price1 == '' && price2 == '' && cataid == 0 && rid == 0) {
		return false;
	} else {
		window.location.href = nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + module + '&' + nv_fc_variable + '=search_result&keyword=' + rawurlencode(keyword) + '&price1=' + price1 + '&price2=' + price2 + '&typemoney=' + typemoney + '&cata=' + cataid + '&rid=' + rid;
	}
	return false;
}
